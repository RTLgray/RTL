<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/Papan.png); background-size: cover;">
    ...
    <div class="row">
      <div class="col s12 m3">
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      <div class="background">
                          <img src="../img/bggray.jpg">
                      </div>
                      <a href="#user"><img class="circle" src="../img/avataruser.jpg"></a>
              ...
              <li><a href="index.php?p=pengaduan"><i class="material-icons">report</i>Pengaduan DiProses</a></li>
              <li><a href="index.php?p=respon"><i class="material-icons">question_answer</i>Laporan Telah Direspon</a></li>
              <li><a href="index.php?p=user"><i class="material-icons">account_box</i>Registrasi Admin/Staff</a></li>
